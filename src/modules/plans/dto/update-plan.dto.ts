...
export class UpdatePlanDto {
  ...
  @ApiPropertyOptional({ example: 25000, description: 'Precio base del plan (1 usuario)' })
  @IsOptional()
  @Type(() => Number)
  ...
  @ApiPropertyOptional({ example: 4000, description: 'Precio por cada usuario adicional' })
  @IsOptional()
  @Type(() => Number)
